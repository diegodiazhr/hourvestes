  ...
  return (
    <div className="flex min-h-screen w-full bg-background">
      <SidebarProvider>
        ...
        >
          <SidebarHeader>
            <div className="flex items-center gap-2">
              <HourvestLogo />
              <span className="text-xl font-bold">HOURVEST</span>
            </div>
          </SidebarHeader>
          <SidebarContent>
            <SidebarMenu>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton tooltip="Mis Alumnos">
                  <Users />
              ...
              <SidebarMenuItem>
                <SidebarMenuButton tooltip="Colegio">
                  <Building />
                  <span>Colegio</span>
                </SidebarMenuButton>
              </SidebarMenuItem>
            ...
            <SidebarMenu>
              ...
              <SidebarMenuItem>
                <button
                  ...
                  className="flex items-center gap-2 px-2 py-1.5 text-sm font-medium rounded-md text-red-500 hover:bg-red-500/10 w-full"
                >
        ...
        {/* Right Sidebar */}
        <RightSidebar students={students} loading={loading} />
      </SidebarProvider>
    </div>
  );
}
...
function RightSidebarTrigger() {
    ...
    const { userProfile } = useAuth();
    return (
        <button onClick={() => setOpenMobile(!openMobile)} className="lg:hidden">
